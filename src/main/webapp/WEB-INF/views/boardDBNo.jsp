			...
			<div class="main-list">
				<ul>
						<li class="group" onclick="prmList(this)" style="border: 1px solid black;">
							<div class="group-id">
								<span>BAT00000005</span>
							</div>
							<div class="group-nm">
								<span>다섯번째 그룹</span>
							</div>
							<div class="group-host">
								<span>호스트5(127.0.0.1)</span>
							</div>
						...
						<li class="group" onclick="prmList(this)" style="border: 1px solid black;">
							<div class="group-id">
								<span>BAT00000004</span>
							</div>
							<div class="group-nm">
								<span>네번째 그룹</span>
							</div>
							<div class="group-host">
								<span>호스트4(127.0.0.1)</span>
							</div>
							<div class="group-cron">
									<span>* * * * * * *</span>
							</div>
