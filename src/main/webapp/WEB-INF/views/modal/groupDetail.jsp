	        	...
	        	<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	      		...
	      		<table class="table table-bordered align-middle bg-white">
					<tr>
	      				<th>그룹ID</th>
	      				<td>
	      					<input class="onlyread form-control" type="text" value="" readonly>    					
	      				</td>
	      			</tr>
					<tr>
						<th>그룹명</th>
						<td style="width: 80%;">
							<input class="readwrite form-control" type="text" readonly>
						</td>
					</tr>
					<tr>
						<th>그룹설명</th>
						<td><input class="readwrite form-control"  type="text" readonly></td>
					</tr>
					<tr>
						<th>호스트명</th>
						<td><input class="readwrite form-control"  type="text" readonly></td>
					...
					<tr>
						<th>자동실행</th>
						<td>
						<select class="readwrite form-control" id="detail-auto">
